 ...
 */
final class Version20250810053908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE fonction_valide ADD created_by VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE fonction_valide_historique DROP created_at, DROP created_by');
        $this->addSql('ALTER TABLE secteur_valide ADD created_by VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE secteur_valide DROP created_by');
        ...
        $this->addSql('ALTER TABLE fonction_valide DROP created_by');
    }
}
